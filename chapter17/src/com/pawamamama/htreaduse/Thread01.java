...
public class Thread01 {
    public static void main(String[] args) {
        ...
        /*    (1)
              ...
              (2)start0是一个本地方法，是JVM调用，底层是c/c++实现
                //真正实现多线程的效果，是start0方法，而不是run
                private native void start0();
                //该线程不会里面执行，只是将线程变成了可运行状态，具体什么时候执行，取决于cpu
                //由cpu同一调度

        *
        * */
        cat.start();//启动线程->最终执行cat的run方法
        //cat.run();//run方法就是一个普通的run方法，并没有真正的启动线程，就会把run方法执行完毕，才向下执行
